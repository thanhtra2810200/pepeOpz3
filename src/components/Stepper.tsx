...
function StepIndicator({ step, currentStep, onClickStep, disableStepIndicators = false }: StepIndicatorProps) {
  ...
  return (
    ...
    >
      <motion.div
        variants={{
          inactive: { scale: 1, backgroundColor: 'rgba(255,255,255,0.05)', color: '#6b7280' },
          active: { scale: 1, backgroundColor: '#4ade80', color: '#4ade80' },
          complete: { scale: 1, backgroundColor: '#22c55e', color: '#4ade80' }
        }}
